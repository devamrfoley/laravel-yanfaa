                ...
                <div class="aa-promo-right">
                  @foreach($categories as $category)
                    ...
                    <div class="aa-single-promo-right">
                      <div class="aa-promo-banner">                      
                        <img src="{{ asset('storage/images/'.$category->image) }}" alt="img">                      
                        <div class="aa-prom-content">
            ...
            <div class="aa-product-area">
              <div class="aa-product-inner">
                ...
                <ul class="nav nav-tabs aa-products-tab">
                  @foreach($categories as $category)
                    <li class="{{ ($loop->first)? 'active' : '' }}"><a href="#{{ $category->title }}" data-toggle="tab">{{ $category->title }}</a></li>
                  @endforeach
                </ul>
                  <!-- Tab panes -->
                  <div class="tab-content">
                    @foreach($categories as $category)
                      ...
                      <div class="tab-pane fade {{ ($loop->first)? 'in active' : '' }}" id="{{ $category->title }}">
                        <ul class="aa-product-catg">
                          @foreach($category->products()->paginate(8) as $product)
                            <!-- start single product item -->
                            <li>
                              <figure>
                                <a class="aa-product-img" href="{{ $product->path() }}"><img src="{{ asset('storage/images/'.$product->image) }}" alt="polo shirt img"></a>
                                <a class="aa-add-card-btn"href="{{ route('addToCart', $product->id) }}"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                  <figcaption>
                                  <h4 class="aa-product-title"><a href="{{ $product->path() }}">{{ $product->title }}</a></h4>
                              ...
                              @elseif($product->salePrice != null)
                                <span class="aa-badge aa-sale">SALE!</span>
                              @endif
                            </li>
                          @endforeach                     
                        </ul>
                        <a class="aa-browse-btn" href="/products">Browse all Product <span class="fa fa-long-arrow-right"></span></a>
                      </div>
                    @endforeach
                  </div>
                  <!-- quick view modal -->                  
